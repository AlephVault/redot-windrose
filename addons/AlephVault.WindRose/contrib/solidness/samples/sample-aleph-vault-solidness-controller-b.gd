...
func _change_solidness():
	"""
	Switches the current character's solidness.
	"""
	
	match _current.entity_rule.solidness:
		AlephVault__WindRose.Contrib.Solidness.EntityRule.Solidness.SOLID:
			_current.entity_rule.solidness = AlephVault__WindRose.Contrib.Solidness.EntityRule.Solidness.GHOST
		AlephVault__WindRose.Contrib.Solidness.EntityRule.Solidness.GHOST:
			_current.entity_rule.solidness = AlephVault__WindRose.Contrib.Solidness.EntityRule.Solidness.HOLE
		AlephVault__WindRose.Contrib.Solidness.EntityRule.Solidness.HOLE:
			_current.entity_rule.solidness = AlephVault__WindRose.Contrib.Solidness.EntityRule.Solidness.SOLID
...
func _ready():
	_options = [
		%Character11b, %Character12b,
		%Character21b, %Character22b
	]
