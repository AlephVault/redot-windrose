...
| `WoodenBench` | Up/down/left/right | Brown: up `(832, 160, 32, 32)`, down `(800, 128, 32, 64)`, left `(768, 128, 32, 64)`, right `(736, 128, 32, 64)`; red: up `(960, 160, 32, 32)`, down `(928, 128, 32, 64)`, left `(896, 128, 32, 64)`, right `(864, 128, 32, 64)` | Up `Vector2.ZERO`, down/left/right `Vector2(0, -32)` | Static | `bench_type` with `BENCH_BROWN`, `BENCH_RED` |
